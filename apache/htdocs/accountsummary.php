...
<div class="wrapper">
	...
	<section class="content">
        <div class="inner">
            <article class="main">
                <h1>DayTrading - Account Summary Page</h1>
		...
		<FORM name="add" method="POST" action="displaysum.php">
			<P><input type="SUBMIT" value="Update Summary"></P>
		</FORM>
				
                <h2>Account Summary</h2>
                <div class="recent">
		<?php echo $_SESSION["acctSum"]; ?>
		</div>
		<h2>Active Triggers</h2>
		<div class="recent">
		<?php echo $_SESSION["triggers"]; ?>
		</div>
